...
t.mentions = function() {
  ...
  return $telegram.on('focus', function() {
    if (!t.mentions_userlist) {
      return $.get("/xhr/mentions_userlist", function(data) {
...
t.mentions_checkhidden = function() {
  var $mentions, $telegram, i, len, mentions, o, ref, u;
  $telegram = $('#telegram');
  ...
  return $mentions.val(JSON.stringify(mentions));
};
